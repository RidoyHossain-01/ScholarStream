...
const AboutUs = () => {
  return (
    <div className="bg-slate-50 text-slate-800">
      {/* Hero Section */}
      <section className="bg-linear-to-r from-primary to-accent text-white py-20 px-6">
      ...
      {/* What We Offer */}
      <section className="bg-base-200 py-20 px-6 rounded-3xl">
      ...
      <section className="bg-slate-100 py-20 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 text-center">
          <div>
            ...
            <p className="text-base-content/60 mt-2">Active Scholarships</p>
          </div>

          <div>
            <h3 className="text-4xl font-bold text-indigo-600">120+</h3>
            <p className="text-base-content/60 mt-2">Partner Universities</p>
          </div>

          <div>
            <h3 className="text-4xl font-bold text-green-600">10K+</h3>
            <p className="text-base-content/60 mt-2">Students Assisted</p>
          </div>
        </div>
      </section>

      {/* Call To Action */}
      <section className="bg-linear-to-r from-primary to-accent text-white py-16 px-6 text-center">
        ...
        <Link
          to={"/all-scholarships"}
          className="bg-accent text-white px-6 py-3 rounded-full font-semibold hover:bg-accent/80 transition"
        >
